...
import { BarChart3Icon, ImageIcon, MousePointerClickIcon, SearchIcon, SparklesIcon } from "lucide-react"
...
export function CampaignTabs({ id }: CampaignTabsProps) {
  ...
  return (
    <Tabs defaultValue="ad-groups" value={activeTab} onValueChange={setActiveTab} className="space-y-4">
      <TabsList>
